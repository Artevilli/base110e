...
UI_CVAR(ui_lastServerRefresh_0, "ui_lastServerRefresh_0_time", "", CVAR_ARCHIVE)
UI_CVAR(ui_lastServerRefresh_1, "ui_lastServerRefresh_1_time", "", CVAR_ARCHIVE)
UI_CVAR(ui_lastServerRefresh_2, "ui_lastServerRefresh_2_time", "", CVAR_ARCHIVE)
UI_CVAR(ui_lastServerRefresh_3, "ui_lastServerRefresh_3_time", "", CVAR_ARCHIVE)
...
UI_CVAR(ui_smallFont, "ui_smallFont", "0.2", CVAR_ARCHIVE)
UI_CVAR(ui_bigFont, "ui_bigFont", "0.5", CVAR_ARCHIVE)
...
UI_CVAR(ui_serverFilterType, "ui_serverFilterType", "0", 0)

//TA: bank values
UI_CVAR(ui_bank, "ui_bank", "0", 0)
UI_CVAR(ui_winner, "ui_winner", "", CVAR_ROM)
