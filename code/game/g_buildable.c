...
static qbool G_BoundsIntersect(const vec3_t mins, const vec3_t maxs,
                                                 ...
                                                 vec3_t          origin )
{
  ...
  int       pointsYielded = 0;
  gentity_t *ent;
  qbool  unique = BG_FindUniqueTestForBuildable( buildable );
...
static void G_SetBuildableMarkedLinkState( qbool link )
{
  int       i;
  gentity_t *ent;
