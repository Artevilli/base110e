...
CG_CVAR(cg_fovAdjust, "cg_fovAdjust", "1", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_fovCustom, "cg_fovCustom", "0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_followKiller, "cg_followKiller", "0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_jetpackMute, "cg_jetpackMute", "0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_lanternLight, "cg_lanternLight", "0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_lanternLightColorRed, "cg_lanternLightColorRed", "1.0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_lanternLightColorGreen, "cg_lanternLightColorGreen", "1.0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_lanternLightColorBlue, "cg_lanternLightColorBlue", "1.0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_lanternLightRadius, "cg_lanternLightRadius", "400.0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_maraZapLight, "cg_maraZapLight", "0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_precisionLoss, "cg_precisionLoss", "0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_viewsize, "cg_viewsize", "100", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_stereoSeparation, "cg_stereoSeparation", "0.4", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_shadows, "cg_shadows", "1", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_scanner, "cg_scanner", "1", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_sense, "cg_sense", "1", CVAR_ARCHIVE, NULL)
...
CG_CVAR(cg_drawTimer, "cg_drawTimer", "1", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_drawClock, "cg_drawClock", "0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_drawFPS, "cg_drawFPS", "1", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_drawDemoState, "cg_drawDemoState", "1", CVAR_ARCHIVE, NULL)
...
CG_CVAR(cg_lagometer, "cg_lagometer", "0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_teslaTrailTime, "cg_teslaTrailTime", "250", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_railTrailTime, "cg_railTrailTime", "400", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_gun_frame, "cg_gun_frame", "0", CVAR_CHEAT, NULL)
...
CG_CVAR(cg_bobCustom, "cg_bobCustom", "0", CVAR_ARCHIVE, NULL)
...
CG_CVAR(cg_debugMove, "cg_debugMove", "0", 0, NULL)
...
CG_CVAR(cg_thirdPerson, "cg_thirdPerson", "0", CVAR_CHEAT, NULL)
CG_CVAR(cg_cameraEyes, "cg_cameraEyes", "0", CVAR_CHEAT, NULL)
CG_CVAR(cg_cameraEyes_Fwd, "cg_cameraEyes_Fwd", "-2", CVAR_CHEAT, NULL)
CG_CVAR(cg_cameraEyes_Up, "cg_cameraEyes_Up", "7", CVAR_CHEAT, NULL)
...
CG_CVAR(cg_drawSurfNormal, "cg_drawSurfNormal", "0", CVAR_CHEAT, NULL)
CG_CVAR(cg_drawBBOX, "cg_drawBBOX", "0", CVAR_CHEAT, NULL)
CG_CVAR(cg_debugAlloc, "cg_debugAlloc", "0", 0, NULL)
CG_CVAR(cg_wwSmoothTime, "cg_wwSmoothTime", "300", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_wwFollow, "cg_wwFollow", "1", CVAR_ARCHIVE|CVAR_USERINFO, NULL)
CG_CVAR(cg_wwToggle, "cg_wwToggle", "1", CVAR_ARCHIVE|CVAR_USERINFO, NULL)
CG_CVAR(cg_unlagged, "cg_unlagged", "1", CVAR_ARCHIVE|CVAR_USERINFO, NULL)
CG_CVAR(cg_depthSortParticles, "cg_depthSortParticles", "1", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_bounceParticles, "cg_bounceParticles", "0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_consoleLatency, "cg_consoleLatency", "3000", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_lightFlare, "cg_lightFlare", "3", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_debugParticles, "cg_debugParticles", "0", CVAR_CHEAT, NULL)
CG_CVAR(cg_debugTrails, "cg_debugTrails", "0", CVAR_CHEAT, NULL)
CG_CVAR(cg_debugPVS, "cg_debugPVS", "0", CVAR_CHEAT, NULL)
CG_CVAR(cg_disableWarningDialogs, "cg_disableWarningDialogs", "0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_disableScannerPlane, "cg_disableScannerPlane", "0", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_tutorial, "cg_tutorial", "1", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_hudFiles, "cg_hudFiles", "ui/hud.txt", CVAR_ARCHIVE, NULL)

CG_CVAR(cg_painBlendUpRate, "cg_painBlendUpRate", "10.0", 0, NULL)
CG_CVAR(cg_painBlendDownRate, "cg_painBlendDownRate", "0.5", 0, NULL)
CG_CVAR(cg_painBlendMax, "cg_painBlendMax", "0.7", 0, NULL)
CG_CVAR(cg_painBlendScale, "cg_painBlendScale", "7.0", 0, NULL)
CG_CVAR(cg_painBlendZoom, "cg_painBlendZoom", "0.65", 0, NULL)

//TA: hack to get class an carriage through to UI module
CG_CVAR(ui_currentClass, "ui_currentClass", "0", 0, NULL)
CG_CVAR(ui_carriage, "ui_carriage", "", 0, NULL)
CG_CVAR(ui_stages, "ui_stages", "0 0", 0, NULL)
CG_CVAR(ui_dialog, "ui_dialog", "Text not set", 0, NULL)
CG_CVAR(ui_loading, "ui_loading", "0", 0, NULL)
CG_CVAR(ui_voteActive, "ui_voteActive", "0", 0, NULL)
CG_CVAR(ui_humanTeamVoteActive, "ui_humanTeamVoteActive", "0", 0, NULL)
CG_CVAR(ui_alienTeamVoteActive, "ui_alienTeamVoteActive", "0", 0, NULL)

CG_CVAR(cg_debugRandom, "cg_debugRandom", "0", 0, NULL)
...
CG_CVAR(cg_smallFont, "ui_smallFont", "0.2", CVAR_ARCHIVE, NULL)
CG_CVAR(cg_bigFont, "ui_bigFont", "0.5", CVAR_ARCHIVE, NULL)
